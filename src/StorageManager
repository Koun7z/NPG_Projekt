...
class StorageManager:
    ...
    def _init(self):
        self._player_scores = {}
        self._quotes = []
        self._path_list={"1":"../resources/texts/easy_qutes.json","2":"../resources/texts//medium_qutes.json","3":"../resources/texts//hard_qutes.json","player":"../resources/players/scores.json"}
        self._diff=1
    def change_difficulty(self, diff:int):
        self._diff=diff
    
    def add_player_score(self, player_name: str, score: int) -> bool:
        self._player_scores[player_name] = score*self._diff
        return True
    ...
    def get_quotes(self) -> List[str]:
        if self._quotes ==None or len(self._quotes)==0:
